// api/estimate-summary-test.js — TEST ONLY, does not touch your real estimate-summary.js
// ─────────────────────────────────────────────────────────
...
// Keyed on destination + star + nights + year + month. Lives only as
// long as this serverless instance stays warm (resets on cold start),
// but needs zero extra setup — good enough for repeated popular queries.
